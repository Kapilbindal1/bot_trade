/**
 * It's a combination of EMA for 5 min interval
 */
...
const indicator = async ({ balance, currentPrice, asset }) => {
  ...
  const prevAdviceEMA = EMA.getAdvice(EMA_result_5m_9[EMA_result_5m_9.length - 2], EMA_result_5m_18[EMA_result_5m_18.length - 2], currentPrice, null, asset);
  const adviceEMA = EMA.getAdvice(EMA_result_5m_9[EMA_result_5m_9.length - 1], EMA_result_5m_18[EMA_result_5m_18.length - 1], currentPrice, prevAdviceEMA.advice, asset);
